...
for f in (
    ...
    ('wally_descriptor_create_checksum', c_int, [c_char_p, POINTER(c_char_p), POINTER(c_char_p), c_size_t, c_uint32, c_char_p_p]),
    ('wally_descriptor_parse_miniscript', c_int, [c_char_p, POINTER(c_char_p), POINTER(c_char_p), c_size_t, c_uint32, c_uint32, c_void_p, c_size_t, c_size_t_p]),
    ('wally_descriptor_to_address', c_int, [c_char_p, POINTER(c_char_p), POINTER(c_char_p), c_size_t, c_uint32, c_uint32, c_uint32, c_char_p_p]),
    ('wally_descriptor_to_addresses', c_int, [c_char_p, POINTER(c_char_p), POINTER(c_char_p), c_size_t, c_uint32, c_uint32, c_uint32, c_uint32, POINTER(wally_descriptor_addresses)]),
    ('wally_descriptor_to_scriptpubkey', c_int, [c_char_p, POINTER(c_char_p), POINTER(c_char_p), c_size_t, c_uint32, c_uint32, c_uint32, c_uint32, c_uint32, c_void_p, c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_add_input_at', c_int, [POINTER(wally_psbt), c_uint32, c_uint32, POINTER(wally_tx_input)]),
    ('wally_psbt_add_output_at', c_int, [POINTER(wally_psbt), c_uint32, c_uint32, POINTER(wally_tx_output)]),
    ...
    ('wally_psbt_elements_init_alloc', c_int, [c_uint32, c_size_t, c_size_t, c_size_t, POINTER(POINTER(wally_psbt))]),
    ...
    ('wally_psbt_input_set_abf', c_int, [POINTER(wally_psbt_input), c_void_p, c_size_t]),
    ('wally_psbt_input_set_asset', c_int, [POINTER(wally_psbt_input), c_void_p, c_size_t]),
    ('wally_psbt_input_set_claim_script', c_int, [POINTER(wally_psbt_input), c_void_p, c_size_t]),
    ...
    ('wally_psbt_input_set_genesis_blockhash', c_int, [POINTER(wally_psbt_input), c_void_p, c_size_t]),
    ...
    ('wally_psbt_input_set_txoutproof', c_int, [POINTER(wally_psbt_input), c_void_p, c_size_t]),
    ...
    ('wally_psbt_input_set_vbf', c_int, [POINTER(wally_psbt_input), c_void_p, c_size_t]),
    ...
    ('wally_psbt_output_add_keypath_item', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t, c_void_p, c_size_t, c_uint_p, c_size_t]),
    ...
    ('wally_psbt_output_set_abf', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
    ('wally_psbt_output_set_asset_commitment', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
    ('wally_psbt_output_set_blinding_pubkey', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
    ('wally_psbt_output_set_keypaths', c_int, [POINTER(wally_psbt_output), POINTER(wally_map)]),
    ('wally_psbt_output_set_nonce', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
    ('wally_psbt_output_set_rangeproof', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
    ('wally_psbt_output_set_redeem_script', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
    ('wally_psbt_output_set_surjectionproof', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
    ...
    ('wally_psbt_output_set_vbf', c_int, [POINTER(wally_psbt_output), c_void_p, c_size_t]),
